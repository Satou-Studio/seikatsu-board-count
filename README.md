...
[App Store](https://apps.apple.com/jp/app/id6794626819)で **Version 1.0.1** を公開済みです。
公開日時は2026-09-10 00:12:21 JST、最新の公開確認日は2026-09-21です。
記録保護の修正と正式名称を反映しています。提出記録はBuild 2です。
審査・公開の根拠と未確認の実機試験は[リリース記録](docs/RELEASE_1.0.1.md)を参照してください。
